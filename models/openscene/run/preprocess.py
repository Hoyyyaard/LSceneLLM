...
def get_parser():
    ...
    parser.add_argument('--config', type=str,
                    default='config/scannet/ours_openseg_pretrained.yaml',
                    help='config file')
...
def precompute_text_related_properties(labelset_name):
    ...
    if 'scannet' in labelset_name:
        ...
        palette = get_palette(colormap='sca.format(scan_name)nnet')
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    from dataset.sceneverse_loader import FusedFeatureLoader, collation_fn_eval_all
    ...
    with torch.no_grad():
        ...
        for rep_i in range(args.test_repeats):
            ...
            for i, (coords, feat, label, feat_3d, mask, inds_reverse, locs_in, feat_in, instance_labels, scan_name) in enumerate(tqdm(val_data_loader)):
                ...
                base_dir = '{}/data/SceneVerse/OpenScene_Scan_Features'.format(os.environ['PROJ_DIR'])
